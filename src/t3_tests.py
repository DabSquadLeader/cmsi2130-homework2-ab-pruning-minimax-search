...
class T3GradingTests(unittest.TestCase):
    ...
    def test_t3_player_t5(self) -> None:
        state = [
            [6, 0, 0, 0],
            [4, 5, 4, 5],
            [0, 0, 3, 0],
        ...
        t3state = T3State(True, state)
        action = choose(t3state)
        self.assertEqual(T3Action(0, 2, 3), action)
        
    def test_t3_player_t6(self) -> None:
        state = [
            [6, 0, 0, 1],
            [0, 5, 4, 5],
            [5, 1, 3, 6],
        ...
        t3state = T3State(False, state)
        action = choose(t3state)
        self.assertEqual(T3Action(1, 0, 6), action)
    
    def test_t3_player_t7(self) -> None:
        state = [
            [6, 0, 0, 1, 0],
            [0, 5, 4, 5, 6],
            [5, 1, 3, 6, 4],
